"""Sigma harvester + calibration report emitter (LatentClass edition).
...
This is the LatentClass edition of the harvester. The harvester itself
does not exercise the SPEED chain or LatentClass lifecycle (it's a native
Euler pass), so the implementation is identical to the original.
"""
...
class MiniMaxH3HarvestToConfigClass:
    """Sigma harvester — native Euler pass with per-step residual capture.

    This is the LatentClass edition of the harvester. The harvester does not
    exercise the SPEED chain or LatentClass lifecycle, so the body is identical
    to `MiniMaxH3HarvestToConfig`.
    """
...
NODE_CLASS_MAPPINGS = {"MiniMaxH3HarvestToConfigClass": MiniMaxH3HarvestToConfigClass}
NODE_DISPLAY_NAME_MAPPINGS = {
    "MiniMaxH3HarvestToConfigClass": "MiniMax H3 SPEED — Sigma Harvest (Native Euler, LatentClass)"
}
__all__ = [
    "NODE_CLASS_MAPPINGS",
    "NODE_DISPLAY_NAME_MAPPINGS",
